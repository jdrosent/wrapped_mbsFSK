...
set ::env(DESIGN_NAME) wrapped_mbsFSK

# add your source files here
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/wrapper.v \
    $::env(DESIGN_DIR)/mbsFSK/src/mbsFSK.v\
    $::env(DESIGN_DIR)/mbsFSK/src/SymbLUT.v\
    $::env(DESIGN_DIR)/mbsFSK/src/sampleClockGen.v\
    $::env(DESIGN_DIR)/mbsFSK/src/LFSRmod.v"
